...
app.use(async function(req, res, next) {
  ...
  req.gdRequest = function(target, params={}, cb=function(){}) {
    ...
    if (params.forceGD || (params.form && params.form.forceGD)) endpoint = "http://www.boomlings.com/database/" //this is the place where it gets the data from. lets change it.
